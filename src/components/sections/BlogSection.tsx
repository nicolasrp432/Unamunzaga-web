...
export const BlogSection: React.FC<BlogSectionProps> = ({ posts, loading = false }) => {
                    ...
                    <div className="p-6">
                      ...
                      >
                        <Link
                          ...
                          className="block group text-blue-900 font-semibold hover:text-blue-700 transition-colors duration-300 flex items-center space-x-1"
                        >
